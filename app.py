...
def generate_forecast(segment_type, segment_name, horizon):
    ...
    fig.update_layout(
        ...
        xaxis=dict(title="Date", gridcolor='#1a3a6e', linecolor='#1a3a6e',
...
> *Forecast generated using Facebook Prophet trained on 2020–2021 historical data.*
"""
    return fig, summary
...
- Nairobi Central: data only Jan to Mar 2020, likely closed, no forecast available
- Metro Market: data ends Nov 2021, missing last month
- Bon Marche Plaza: opened Aug 2021, only 4 months of data, forecast has wider uncertainty
- COVID-19 caused a 56% revenue drop from Jan to Apr 2020

BRAND INSIGHTS:
- Crust Co. dominates at 57% of total revenue ($9M)
- Flame & Feather is second at 24% ($3.75M)
- Crust Co. leads at 7 of 8 sites; Flame & Feather leads only at Metro Market
- Sunday is the highest revenue day; Monday is the lowest

SITE INSIGHTS:
- Junction Plaza is the top site at $4.82M, closely followed by Crossroads Mall at $4.70M
...
def build_dashboard():
    ...
    fig6 = go.Figure(go.Pie(
        ...
        hole=0.45,
        marker=dict(
            colors=['#c9a84c','#1e2d5e','#2ecc71','#e74c3c','#9b59b6','#1abc9c','#f39c12','#34495e'],
...
/* ── Radio & checkboxes ── */
.gradio-container .wrap input[type=radio] + span,
.gradio-container .wrap input[type=checkbox] + span {
    color: #c8d8f0 !important;
}
...
div[class*="message"][class*="bot"] strong {
    color: #c9a84c !important;
}
...
with gr.Blocks(title="Continental QSR Intelligence | Netrisyl Insights", css=css) as demo:
    ...
    <div style="background:linear-gradient(135deg,#0d1b2a,#1a3a5c);
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px;">
            <div style="display:flex;align-items:center;gap:14px;">
                <img src="/file=NI logo.png"
                     style="height:55px;object-fit:contain;"
                     onerror="this.style.display='none'" alt="Netrisyl Insights"/>
                <div>
            ...
            <div style="text-align:right;">
                <p style="color:#c9a84c;margin:0;font-size:12px;font-weight:700;letter-spacing:1px;">NETRISYL INSIGHTS</p>
                <p style="color:#7fb3d3;margin:2px 0 0;font-size:11px;">Data · Analytics · Intelligence</p>
            </div>
        </div>
        <div style="display:flex;gap:12px;margin-top:14px;flex-wrap:wrap;">
            <div style="background:#0a1628;padding:8px 18px;border-radius:6px;border:1px solid #1a3a6e;min-width:90px;">
    ...
    with gr.Tabs():
        ...
        with gr.TabItem("💬 Intelligence Chat"):
            ...
            <div style="background:#0a1628;border:1px solid #1a3a6e;border-radius:8px;
                ...
                <p style="color:#c9a84c;font-weight:600;margin:0 0 6px;font-size:13px;">
                    💡 Ask anything about the Continental QSR Group data
                </p>
    ...
    <div style="text-align:center;margin-top:16px;padding:12px;border-top:1px solid #1a3a6e;">
        <p style="color:#c9a84c;font-size:12px;font-weight:600;margin:0;letter-spacing:1px;">
            NETRISYL INSIGHTS
        </p>
